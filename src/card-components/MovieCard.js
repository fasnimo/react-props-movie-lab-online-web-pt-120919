  ...
  render() {
    ...
    return (
      <div className="movie-card">
        <CardFront img={posterMap[this.props.poster]} />
        <CardBack IMDBRating={this.props.IMDBRating} title={this.props.title} genres={this.props.genres} poster={this.props.poster}/>
      </div>
    )
  }
}
